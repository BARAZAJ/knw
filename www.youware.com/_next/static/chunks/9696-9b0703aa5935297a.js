(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [9696], {
            ...
            let d = e => {
                ...
                u = e => {
                    let {
                        ...
                        emojis: v
                    } = (0, n.k)(), [b, j] = (0, s.useState)(!1), [g, w] = (0, s.useState)(!1), [y, _] = (0, s.useState)(!1), [N, k] = (0, s.useState)(!1), S = (0, i.I)(), P = (0, s.useRef)(null), C = (0, s.useRef)(null);
                    (0, s.useEffect)(() => {
                        let e = () => {
                                if (C.current) {
                                    let {
                    ...
                    return (0, r.jsxs)("div", {
                        ...
                        children: [f && (0, r.jsxs)(r.Fragment, {
                            ...
                            onMouseEnter: () => {
                                S || (P.current && clearTimeout(P.current), j(!0))
                            },
                            onMouseLeave: () => {
                                S || g || (P.current = setTimeout(() => {
                                    j(!1)
                                }, 100))
                            },
        ...
        6009: (e, t, a) => {
            ...
            let N = () => {
                ...
                let B = async (e, a) => {
                    ...
                    t(!0), await k({
                        ...
                        action: async () => {
                            ...
                            await S(e, a), await p(j.V, "create"), f("conversion", {
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)(D, {}), (0, r.jsxs)("div", {
                        ...
                        children: [T.length > 0 && (0, r.jsx)(c.A, {
                            attachments: T,
                            onDelete: z,
                            onRetry: A
                        }), (0, r.jsx)("textarea", {
                    ...
                    }), (0, r.jsx)(F, {}), (null == E ? void 0 : E.plan) === "Free" && (null == P ? void 0 : P.commit.will_update_at) ? (0, r.jsxs)("div", {
                        className: "bg-brand/6 absolute right-4 bottom-[-42px] left-4 flex h-[42px] items-center justify-between gap-2 rounded-b-[12px] px-3 text-center text-[12px] text-black/45",
                        role: "usage-status",
                ...
                C = async (e, t) => {
                    try {
                        ...
                        let l = r.some(e => e.name.endsWith(".tsx")),
                            s = new(await a.e(9311).then(a.t.bind(a, 9311, 23))).default;
                        for (let e of r) {
            ...
            let z = e => {
                    ...
                    return (0, s.useEffect)(() => {
                        ...
                        onDragOver: P,
                        onDrop: e => {
                            e.preventDefault(), e.stopPropagation(), A(async () => {
                                U(e)
                            }, () => {
                        ...
                        id: "upload-file-tab",
                        children: [(0, r.jsx)(z, {}), (0, r.jsx)(j, {}), (0, r.jsx)(_, {
        ...
        9230: (e, t, a) => {
            ...
            let b = e => {
                ...
                let {
                    ...
                    tabName: c,
                    onExposure: d
                } = e, [p, b] = (0, s.useState)(!1), j = (0, s.useRef)(null), g = (0, x.useRouter)(), w = (0, s.useRef)(null), {
                    track: y
                } = (0, u.s)();
                (0, s.useEffect)(() => {
                    ...
                    return j.current && e.observe(j.current), () => e.disconnect()
            ...
            function j() {
                return (0, r.jsx)("div", {
                    ...
                    children: Array(6).fill(0).map((e, t) => (0, r.jsxs)("div", {
            ...
            function g(e) {
                let {
                    ...
                    initialProjects: n,
                    isNewInstall: c
                } = e, [x, m] = (0, s.useState)(a), [f, h] = (0, s.useState)(c), [v, g] = (0, s.useState)(n), [w, y] = (0, s.useState)(!1), [_, N] = (0, s.useState)(null), [k, S] = (0, s.useState)({
                    next_cursor: "",
                    has_more: !0
                }), [P, C] = (0, s.useState)(!1), E = (0, s.useRef)(null), U = (0, s.useRef)(null), T = (0, s.useRef)(!1), {
                    track: R,
                    inject: z
                } = (0, u.s)(), {
                    handleExposure: A
                ...
                let F = async function() {
                    ...
                    I = e => {
                        m(e), g([]), F(!0, e.category_id), R("home_category_tab_click", {
                            tab_name: e.display_name
                        })
                    },
                    L = () => {
                        w || P || !k.has_more || F(!1, x ? x.category_id : void 0)
                    },
                    M = (e, t) => {
                        g(a => a.map(a => a.project_id === e.project_id ? { ...a,
                            interaction: t
                        } : a))
                    };
                return (0, s.useEffect)(() => (E.current && E.current.disconnect(), E.current = new IntersectionObserver(e => {
                    let [t] = e;
                    !t.isIntersecting || !k.has_more || w || P || _ || L()
                }, {
                    rootMargin: "0px 0px 600px 0px",
                    threshold: .1
                }), U.current && E.current.observe(U.current), () => {
                    E.current && E.current.disconnect()
                }), [k.has_more, w, P, _, L]), (0, r.jsxs)("div", {
                    ...
                    }), w ? (0, r.jsx)(j, {}) : (0, r.jsxs)(r.Fragment, {
                        children: [(0, r.jsx)("div", {
        ...
        9696: (e, t, a) => {
            Promise.resolve().then(a.bind(a, 6009)), Promise.resolve().then(a.bind(a, 9230)), Promise.resolve().then(a.bind(a, 6450)), Promise.resolve().then(a.bind(a, 2343))
        }
    }
]);