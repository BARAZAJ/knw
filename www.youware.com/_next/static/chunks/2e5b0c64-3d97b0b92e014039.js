...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
            [8888], {
                706: (e, t, n) => {
                        ...
                        class e6 extends e3 {
                            ...
                            static credential(e) {
                                return eG._fromParams({
                                    ...
                                    signInMethod: e6.FACEBOOK_SIGN_IN_METHOD,
                                    accessToken: e
                                })
                            }
                        ...
                        e6.FACEBOOK_SIGN_IN_METHOD = "facebook.com", e6.PROVIDER_ID = "facebook.com";
                        class e4 extends e3 {
                            constructor() {
                        ...
                        class e8 extends e3 {
                            ...
                            static credential(e, t) {
                                return eG._fromParams({
                                    providerId: e8.PROVIDER_ID,
                                    signInMethod: e8.TWITTER_SIGN_IN_METHOD,
                                    oauthToken: e,
                                    oauthTokenSecret: t
                                })
                            }
                            static credentialFromResult(e) {
                                return e8.credentialFromTaggedObject(e)
                            }
                            static credentialFromError(e) {
                                return e8.credentialFromTaggedObject(e.customData || {})
                            }
                            static credentialFromTaggedObject({
                                _tokenResponse: e
                            }) {
                                ...
                                if (!t || !n) return null;
                                try {
                                    return e8.credential(t, n)
                                } catch (e) {
                                    return null
                                }
                            }
                        }
                        e8.TWITTER_SIGN_IN_METHOD = "twitter.com", e8.PROVIDER_ID = "twitter.com";
                        class e5 {
                            constructor(e) {
                            ...
                            static async _forOperation(e, t, n) {
                                return await e._updateTokensIfNecessary(n, !0), new e5({
                                    user: e,
                                    providerId: e7(n),
                                    _tokenResponse: n,
                                    operationType: t
                        ...
                        async function tn(e, t, n = !1) {
                            ...
                            return e5._forOperation(e, "link", r)
                        }
                        ...
                        async function ti(e, t, n = !1) {
                            ...
                            try {
                                ...
                                return _(e.uid === o, i, "user-mismatch"), e5._forOperation(e, s, r)
                            } catch (e) {
                        ...
                        async function ts(e, t, n = !1) {
                            ...
                            let i = "signIn",
                                s = await tt(e, i, t),
                                a = await e5._fromIdTokenResponse(e, i, s);
                            ...
                            static _fromError(e, t) {
                                ...
                                return new tI(s, i, async e => {
                                    ...
                                    switch (t.operationType) {
                                        case "signIn":
                                            let o = await e5._fromIdTokenResponse(n, t.operationType, a);
                                            return await n._updateCurrentUser(o.user), o;
                                        case "reauthenticate":
                                            return _(t.user, n, "internal-error"), e5._forOperation(t.user, t.operationType, a);
                                        default:
                                            d(n, "internal-error")
                                    }
                                })
                        ...
                        class t3 extends tQ {
                            ...
                            async execute() {
                                let e = t2.get(this.auth._key());
                                if (!e) {
                                    try {
                                        let t = await t6(this.resolver, this.auth) ? await super.execute() : null;
                                        e = () => Promise.resolve(t)
                                    } catch (t) {
                                        e = () => Promise.reject(t)
                                    }
                                    t2.set(this.auth._key(), e)
                                }
                                return this.bypassAuthState || t2.set(this.auth._key(), () => Promise.resolve(null)), e()
                            }
                            async onAuthEvent(e) {
