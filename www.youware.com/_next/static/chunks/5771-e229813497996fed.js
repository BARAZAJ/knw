    ...
    [5771], {
        ...
        2997: (e, t, a) => {
                ...
                let {
                    ...
                    try {
                        ...
                        p.Ay.error("Install integration failed", void 0, {
                            ...
                            mcp_tool_name: t.name,
                            result: "failed"
                        }), e instanceof Error && e.message ? y(e.message) : (0, x.P)({
            ...
            function v(e) {
                let {
                    ...
                    if (p.Ay.info("Install integration", e), b("mcp_install", {
                        ...
                        h(!0), await f(e, {}), p.Ay.info("Install integration success", e), (0, x.P)({
                    ...
                    try {
                        h(!0), await m(e), p.Ay.info("Uninstall integration success", e), (0, x.P)({
            ...
            function w(e) {
                ...
                let m = !o && !u && r.length > 0,
                    p = [],
                    x = [];
                return m && (p = r.filter(e => e.is_configured), x = r.filter(e => !e.is_configured)), (0, l.jsxs)(l.Fragment, {
                    children: [(0, l.jsx)(b, {
                        onClose: t
                    }), m && (0, l.jsx)(y, {
                        installedIntegrations: p,
                        uninstalledIntegrations: x,
                        onConfigIntegration: a
                    }), o && (0, l.jsxs)("div", {
                        ...
                        if (!i) {
                            ...
                            return f = new Promise(async (e, a) => {
                                ...
                                let b = null !== (d = null === (l = h.data) || void 0 === l ? void 0 : l.subscription.total_remaining) && void 0 !== d ? d : 0,
                                    ...
                                    w = null !== (x = null == v ? void 0 : v.limit) && void 0 !== x ? x : 0,
                                    j = {
                                        commit: {
                                            enabled: b > 0,
                                            free_count: b,
                                        ...
                                        is_vip: null !== (g = null === (i = h.data) || void 0 === i ? void 0 : i.subscription.is_vip) && void 0 !== g && g
                                    };
                                s(j), f = null, e(j)
                            })
                        }
            ...
            let o = e => {
                ...
                c = e => {
                    let {
                        ...
                        className: c = "",
                        editable: d = !0
                    } = e, [u, f] = (0, r.useState)(null), [m, p] = (0, r.useState)(!1), [x, g] = (0, r.useState)(!1), h = (0, r.useRef)(null);
        ...
        7895: (e, t, a) => {
            ...
            let o = () => {
                ...
                }, []), x = (0, l.useCallback)(e => e.type.startsWith("image/") ? "image" : "application/pdf" === e.type ? "pdf" : e.type.startsWith("audio/") ? "audio" : "file", []), g = (0, l.useCallback)(async e => {
                    let t = x(e),
                        l = "",
                        r = (0, n.F)(t);
                    if ("image" === t) {
        ...
        8618: (e, t, a) => {
            ...
            let n = function(e) {
                ...
                if (!(null == e ? void 0 : e.commit.enabled)) {
                    if (t) {
                        let t = (null == e ? void 0 : e.is_vip) ? "All tasks for today are used. New tasks available at ".concat(null == e ? void 0 : e.commit.will_update_at) : "You've used up your free tasks for today. Upgrade for more tasks.";
                        (0, l.P)({
                            message: t,
                            type: "error"
                        })
