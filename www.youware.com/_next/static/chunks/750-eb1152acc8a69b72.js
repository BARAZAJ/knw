            ...
            let p = "yourware-emoji-list",
                ...
                T = () => {
                    try {
                        ...
                        e && (y = JSON.parse(atob(e)))
                    } catch (e) {
                        l.vF.error("Failed to load Lottie cache", e), y = {}, localStorage.removeItem(f)
                    }
                },
                j = () => {
                    try {
                        localStorage.setItem(f, btoa(JSON.stringify(y)))
                    } catch (e) {
                        l.vF.error("Failed to save Lottie cache", e)
                    }
                },
                x = async e => {
                    if (!e || y[e] && y[e].expireTime > Date.now() && y[e].data) return;
                ...
                F = e => {
                    b || (b = !0, T(), setTimeout(async () => {
                        try {
                            l.vF.info("Start preloading all Lottie animations");
                            let t = e.filter(e => e.lottie).map(e => e.lottie);
                            await Promise.all([...new Set(t)].map(e => x(e))), l.vF.info("All Lottie animations preloaded successfully")
                        } catch (e) {
                ...
                O = e => e ? y[e] && y[e].expireTime > Date.now() && y[e].data ? y[e].data : (w.has(e) || setTimeout(() => {
                ...
                L = async function() {
                    ...
                    if (!e) {
                        ...
                        if (e.length > 0) return m = e, t ? setTimeout(() => {
                            L(!0).catch(console.error)
                        }, 0) : b || F(e), m
                    }
                    try {
                        g = !0;
                        let e = (await n()).data || [];
                        return m = e, k(e), b || F(e), S(e), e
                    } catch (e) {
                        return l.vF.error("Failed to fetch emojis", e), S(m), m
                    } finally {
                        g = !1
                    }
                },
